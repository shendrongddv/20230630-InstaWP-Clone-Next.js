...
const MainReview = () => {
  const data = reviewsA[0];

  return (
    <section className="section-py bg-[#00231f] bg-[url(/backgrounds/2.svg)] bg-cover bg-center bg-no-repeat px-6">
      <div className="container">
        <div className="flex flex-col items-center">
          <div className="w-full shadow-2xl drop-shadow-2xl md:w-4/5">
            ...
            <div className="rounded-3xl bg-[#00231f]/80 pt-8 md:pt-16">
